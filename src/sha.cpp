...
namespace shiny {
    ...
    std::array<uint32_t, 5> SHA0::getDisgest() const {
        ...
        for (int i = 0; i < 5; i++) r[i] = hashes[hashes.size() - 1][i];
        return r;
    }
    ...
    std::array<uint32_t, 7> SHA224::getDisgest() const {
        ...
        for (int i = 0; i < 7; i++) r[i] = hashes[hashes.size() - 1][i];
        return r;
    }
    ...
    std::array<uint32_t, 8> SHA256::getDisgest() const {
        ...
        for (int i = 0; i < 8; i++) r[i] = hashes[hashes.size() - 1][i];
        return r;
    }
    ...
    std::array<uint64_t, 6> SHA384::getDisgest() const {
        ...
        for (int i = 0; i < 6; i++) r[i] = hashes[hashes.size() - 1][i];
        return r;
    }
